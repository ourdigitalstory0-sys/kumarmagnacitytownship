...
export default function MarketInsightsPage() {
  return (
    <main className="min-h-screen bg-dark">
      ...
      <PillarTemplate
        heroBadge="Premium Intelligence 2026"
        heroTitle="East Pune Market Intelligence Hub"
        heroSubtitle="Quantifying the Kharadi-Hadapsar-Magarpatta Wealth Corridor. Detailed micro-market analysis for strategic NA bungalow plot investments."
      >
